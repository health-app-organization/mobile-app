...
const StackWrapper = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="start" component={ScreenDisplay} />
      <Stack.Screen name="slider" component={Slider} />
      <Stack.Screen name="identity" component={Identity} />
      <Stack.Screen name="health-seeker" component={HealthSeekerRouter} />
      <Stack.Screen name="health-provider" component={HealthProviderRouter} />
    </Stack.Navigator>
  );
};
