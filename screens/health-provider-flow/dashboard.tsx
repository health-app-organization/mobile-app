        ...
        <View className="flex-1">
            <ScrollView className="flex-1">
                <View className="p-4 gap-y-4">
                    ...
                    <View className="gap-y-5">
                        <View className="flex-row justify-between items-center">
                            <Text className="font-semibold text-base">Appointments Statistics</Text>
                            <TouchableOpacity
                                onPress={() =>
                                    navigation.navigate("health-provider", {
                                        screen: "dashboard",
    ...
    return (
        <View className="flex-1 bg-white rounded-lg p-3 gap-y-3">
            ...
            <View className="gap-y-1">
                ...
                <Text className="text-greyText font-normal text-sm">08:00AM - 08:30AM</Text>
                <Text className="text-greyText font-normal text-sm">Morning Session</Text>
            </View>
        </View>
    )
}
