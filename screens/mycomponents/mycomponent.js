...
export const CustomButton=({Textname,onPress,backgroundColor,TextColor,borderWidth,borderColor})=>{
    return(
        <>
        <TouchableOpacity style={[
            ...
            ,customstyle.buttonstyle
             ...
             onPress={onPress}>
            <Text style={[Textstyles.text_button,{color:TextColor}]}>{Textname}</Text>
       </TouchableOpacity>
        </>
    )
}
...
export const MyDivider=({Color,width})=>{
    ...
    <View style={{backgroundColor:Color,height:1,width:width}}/>
                 
    )
}
export const Box=({inputText})=>{
    return(
        <View style={[customstyle.boxstyle]} className="flex justify-center items-center">
