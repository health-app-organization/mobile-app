        ...
        <View className=" w-[232px] h-[175px]  ml-8 mt-16">
          ...
          >
            <FontAwesome
              ...
              size={15}
              color="#000000"
              style={{ alignSelf: 'center', marginTop: 'auto', marginBottom: 'auto' }} // Center the icon
            />
          </TouchableOpacity>
          <Text className=" text-[24px] font-[700] leading-[36px] mt-2" style={[Textstyles.text_medium]} >Praise icon</Text>
          <Text className=" text-[16px] leading-[24px] mb-1 " style={{ color: 'rgba(0, 0, 0, 0.5)' }} >calebomojuko@gmail.com</Text>
          <Text className=" text-[16px] leading-[24px] " style={{ color: 'rgba(0, 0, 0, 0.5)' }} >+234 8164724627</Text>
        </View>
        <View className=" w-full flex justify-center items-center pt-20">
          <View className="  w-[394px] h-[272px]">
            <TouchableOpacity className=" w-full h-[90px] flex justify-between items-center flex-row  border-b-1   "
              ...
              <View className=" flex-row w-[155px] justify-between items-center ml-[24px]">
                ...
                <View><Text style={[Textstyles.text_medium]}>My Wallet</Text></View>
              </View>
              <View className=" flex justify-center items-center w-8 h-8 mr-[8]">
                <Ionicons name="chevron-forward" size={32} color="#0099b8" /></View>
            </TouchableOpacity>
            <TouchableOpacity className=" w-full h-[90px] flex justify-between items-center flex-row  border-b-1   "
              style={{ borderBottomColor: 'rgba(0, 0, 0, 0.2)' }}>
              <View className=" flex-row w-[250px]  justify-between items-center  ml-[24px]">
                ...
                <View><Text style={[Textstyles.text_medium]}>My Medical Records</Text></View>
              </View>
              <View className=" flex justify-center items-center w-8 h-8 mr-[8]">
                <Ionicons name="chevron-forward" size={32} color="#0099b8" /></View>
            </TouchableOpacity>
            <TouchableOpacity className=" w-full h-[90px] flex justify-between items-center flex-row  border-b-1   "
              ...
              <View className=" flex-row w-[185px]  justify-between items-center  ml-[24px]">
                ...
                <View><Text style={[Textstyles.text_medium]}>Order History</Text></View>
              </View>
              <View className=" flex justify-center items-center w-8 h-8 mr-[8]">
                <Ionicons name="chevron-forward" size={32} color="#0099b8" /></View>
            </TouchableOpacity>
            ...
            >
              <View className=" flex-row w-[200px]  justify-between items-center  ml-[24px]">
                ...
                <View><Text style={[Textstyles.text_medium]}>Order Tracking</Text></View>
              </View>
              <View className=" flex justify-center items-center w-8 h-8 mr-[8]">
                <Ionicons name="chevron-forward" size={32} color="#0099b8" /></View>
            </TouchableOpacity>
